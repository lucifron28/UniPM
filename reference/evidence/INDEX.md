...
| EXP-003 | experiment | Granite multilingual maintenance retrieval baseline | executed | locally-executed | `8f91e04` | [record](experiments/EXP-003-granite-multilingual-retrieval-baseline.md) | Local offline Granite baseline over the fictional 24-query fixture with latency and candidate-cap evidence; conditional pass, not production evidence. |
