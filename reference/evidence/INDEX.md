...
| TEST-002 | test-run | Observability metrics and local monitoring baseline | executed | locally-executed | `c4fc0df` | [record](test-runs/TEST-002-observability-baseline.md) | Backend and local Compose observability proof with sanitized artifacts and hashes. |
