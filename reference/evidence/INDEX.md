...
| TEST-001 | test-run | Current backend verification baseline | executed | locally-executed | `63f9300` | [record](test-runs/TEST-001-current-backend-baseline.md) | Clean-worktree restore/build/full tests, SQL scope, and lexical benchmark executed. |
| EXP-001 | experiment | Lexical SQL Server Full-Text synthetic baseline | reviewed | locally-executed | `63f9300` | [record](experiments/EXP-001-lexical-fts-baseline.md) | Immutable 24-query lexical baseline with sanitized reports. |
