...
| TEST-007 | test-run | Maintenance review fresh migration verification | executed | locally-executed | `847495d` | [record](test-runs/TEST-007-maintenance-review-correction.md) | Fresh SQL Server volume, explicit migration, seed, rebuild, readiness, and degraded source-only review; real summary and semantic quality remain unclaimed. |
