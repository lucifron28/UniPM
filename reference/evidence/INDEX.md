...
| TEST-002 | test-run | Observability metrics and local monitoring baseline | executed | locally-executed | `3b2e742` | [record](test-runs/TEST-002-observability-baseline.md) | Backend and local Compose observability proof with sanitized artifacts and hashes. |
