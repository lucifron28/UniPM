...
void main() {
  group('Field-Worker Home Dashboard UX', () {
    testWidgets('renders quick action buttons: Scan QR, Enter Code, and Search', (
      tester,
    ) async {
    ...
    testWidgets('displays active draft batch progress cards and submitted batches', (
      tester,
    ) async {
  ...
  group('Inspection Completion Bottom Sheet', () {
    testWidgets('shows inspection confirmation, batch progress, and actions', (
      ...
      expect(find.text('Asset FE-CS-005 successfully inspected.'), findsOneWidget);
