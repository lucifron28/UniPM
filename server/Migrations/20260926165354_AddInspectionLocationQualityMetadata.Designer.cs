...
namespace UniPM.Api.Migrations
{
    ...
    [Migration("20260926165354_AddInspectionLocationQualityMetadata")]
    partial class AddInspectionLocationQualityMetadata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UniPM.Api.Models.Asset", b =>
                {
                    ...
                    b.Property<double?>("VerificationLatitude")
                        .HasColumnType("float");

                    b.Property<double?>("VerificationLongitude")
                        .HasColumnType("float");

                    b.Property<double?>("VerificationRadiusMeters")
                        .HasColumnType("float");
                    ...
                    b.ToTable("Assets", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Assets_VerificationLocation_Complete", "([VerificationLatitude] IS NULL AND [VerificationLongitude] IS NULL AND [VerificationRadiusMeters] IS NULL) OR ([VerificationLatitude] IS NOT NULL AND [VerificationLongitude] IS NOT NULL AND [VerificationRadiusMeters] IS NOT NULL AND [VerificationLatitude] BETWEEN -90 AND 90 AND [VerificationLongitude] BETWEEN -180 AND 180 AND [VerificationRadiusMeters] > 0)");
                        });
                });

            modelBuilder.Entity("UniPM.Api.Models.InspectionLocationAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("MeasuredLongitude")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("ActorUserId", "CapturedAt");
            ...
            modelBuilder.Entity("UniPM.Api.Models.InspectionRecord", b =>
                {
                    ...
                    b.Property<Guid?>("LocationAttemptId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UniPM.Api.Models.PreventiveMaintenanceSchedule", b =>
                {
                    ...
                    b.Property<Guid?>("AssignedSupervisorUserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UniPM.Api.Models.InspectionLocationAttempt", b =>
                {
                    ...
                    b.HasOne("UniPM.Api.Models.PreventiveMaintenanceSchedule", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UniPM.Api.Models.InspectionRecord", b =>
                {
                    ...
                    b.HasOne("UniPM.Api.Models.InspectionLocationAttempt", null)
                        .WithMany()
                        .HasForeignKey("LocationAttemptId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("UniPM.Api.Models.PreventiveMaintenanceSchedule", b =>
                {
                    ...
                    b.HasOne("UniPM.Api.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("AssignedSupervisorUserId")
                        .OnDelete(DeleteBehavior.NoAction);
