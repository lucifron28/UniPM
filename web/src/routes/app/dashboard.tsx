    ...
    <section aria-labelledby="dashboard-title" className="max-w-6xl">
      ...
      <Card className="mt-8 p-6 shadow-none">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-6 text-[var(--text-secondary)]">
          Only acknowledged rows become official inspection history. Schedule
          completion occurs after whole-form acknowledgement. Provisional UniPM
          file numbers remain independent from the external GSD work management
          system.
        </p>
      </Card>
    </section>
